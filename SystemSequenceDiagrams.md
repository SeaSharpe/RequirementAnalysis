...
## Users / Visitors
### Sign up for account
![Sign up for account](./SSD/SignUpForAccount.jpg)
### Login to site
![Login to site](./SSD/LoginToSite.jpg)
### Setup Profile
![Setup Profile](./SSD/SetupProfile.jpg)
### Opt In/Out of receiving promotional materials by email
![Opt In/Out of receiving promotional materials by email](./SSD/OptInOutofreceivingpromotionalmaterialsbyemail.jpg)
### Set Platform Preference
![Set Platform Preference](./SSD/SetPlatformPreference.jpg)
### Set game category preference
![Set game category preference](./SSD/Setgamecategorypreference.jpg)
### User registers a credit card
![User registers a credit card](./SSD/Userregistersacreditcard.jpg)
### Add or Modify a shipping address
![Add or Modify a shipping address](./SSD/AddorModifyashippingaddress.jpg)
### Delete a shipping address
![Delete a shipping address](./SSD/Deleteashippingaddress.jpg)
### Reset user password
![Reset user password](./SSD/Resetuserpassword.jpg)
### User/Visitor searches for an event
![Missing Diagram](./SSD/)
### Register for an event
![Register for an event](./SSD/Registerforanevent.jpg)
### View game reviews
![Missing Diagram](./SSD/)
### Review games
